...
namespace Prime.Progreso.Data.Migrations
{
    ...
    [Migration("20230913180526_AddSolutionColumnToAssignments")]
    partial class AddSolutionColumnToAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prime.Progreso.Data.Entities.AssignmentToCodingChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InternId", "CodingChallengeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Prime.Progreso.Data.Entities.KeywordDescriptionMultiPlayerResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("KeywordDescriptionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("KeywordDescriptionId");

                    b.ToTable("KeywordDescriptionMultiPlayerResults");
                });

            modelBuilder.Entity("Prime.Progreso.Data.Entities.KeywordDescriptionSinglePlayerResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("KeywordDescriptionSinglePlayerResults");
                });

            modelBuilder.Entity("Prime.Progreso.Data.Entities.KeywordMultiPlayerResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("KeywordMultiPlayerResults");
                });

            modelBuilder.Entity("Prime.Progreso.Data.Entities.KeywordSinglePlayerResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("KeywordSinglePlayerResults");
                });
            ...
            modelBuilder.Entity("Prime.Progreso.Data.Entities.QuizAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Prime.Progreso.Data.Entities.TestCase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Prime.Progreso.Data.Entities.AssignmentToCodingChallenge", b =>
                {
                    b.HasOne("Prime.Progreso.Data.Entities.CodingChallenge", "CodingChallenge")
                        .WithMany()
            ...
            modelBuilder.Entity("Prime.Progreso.Data.Entities.KeywordDescriptionMultiPlayerResult", b =>
                {
                    b.HasOne("Prime.Progreso.Data.Entities.KeywordDescription", "KeywordDescription")
                        .WithMany()
                        .HasForeignKey("KeywordDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KeywordDescription");
                });
